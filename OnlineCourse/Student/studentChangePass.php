...
<div class="col-sm-6 m-3 shadow p-3 pb-5 bg-body rounded text-white" style="background: teal">
	<div class="row">
		<div class="col-sm-6">
			<form class="mt-5 mx-5" method="POST">
				<div class="form-group">
					<label for="inputEmail">Email</label>
					<input type="email" class="form-control shadow p-3 bg-body rounded" id="inputEmail" value="<?php  echo $stuEmail ?>" readonly>
				</div>
		

		<div class="form-group">
			<label for="inputnewpassword">New Password</label>
			<input type="password" class="form-control shadow p-3 bg-body rounded" id="inputnewpassword" placeholder="New Password" name="stuNewPass"> 
		</div>
