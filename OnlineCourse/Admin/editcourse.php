...
<div class="col-sm-6 mt-5 mx-5 jumbotron">
	...
	<form action="" method="POST" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<img src="<?php if(isset($row['course_img'])){ echo $row['course_img']; } ?>" alt="Thumbnal of this photo" class="img-thumbnail">
			<input type="file" class="form-control-file" id="course_img" name="course_img">
		</div>

		<div class="text-center">
			<button type="submit" class="btn btn-danger" id="requupdate" name="requupdate">Update</button>
